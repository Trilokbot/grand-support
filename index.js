...
automodCommand
  ...
  .addSubcommand(command =>
    command
      .setName("repeated")
      .setDescription(
        "Configure repeated-message protection"
      )
      .addBooleanOption(option =>
        option
          .setName("enabled")
  ...
  .addSubcommand(command =>
    command
      .setName("threshold")
      .setDescription(
        "Configure AutoMod threshold"
      )
      .addStringOption(option =>
        option
          .setName("type")
          .setDescription(
            "spam, mentions, caps, repeated"
          )
          .setRequired(true)
      )
...
const automodCommand =
  new SlashCommandBuilder()
    .setName("automod")
    .setDescription("Configure Advanced AutoMod");
...
automodCommand
  ...
  .addSubcommand(s =>
    s.setName("caps")
      .setDescription("Configure caps protection")
      .addIntegerOption(o =>
        o.setName("percent")
  ...
  .addSubcommand(s =>
    s.setName("badwords")
      .setDescription("Enable or disable bad words")
      .addBooleanOption(o =>
        o.setName("enabled")
          .setDescription("Enabled")
          .setRequired(true)
